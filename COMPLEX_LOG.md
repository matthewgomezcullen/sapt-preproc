...
Only the 36 complexes the tests use are kept under `src/data`; the rest were measured during dataset-wide surveys and would need re-downloading to re-check.
