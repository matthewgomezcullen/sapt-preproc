...
However, this reduces the performance of `_protonate`, so this can be reversed.

Minimisation is not held to this. Pinning it to the reference platform would cost far more than protonation does.
